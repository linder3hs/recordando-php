                ...
                <form>
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="mb-4">
                            ...
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="fecha_registro" wire:model="fecha_registro">
                        </div>

                        <div class="mb-4">
                            <label for="fech_devol" class="block text-gray-700 text-sm font-bold mb-2">fech_devol:</label>
                            <input type="date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="fech_devol" wire:model="fech_devol">
                        </div>
